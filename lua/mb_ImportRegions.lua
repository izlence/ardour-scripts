...
for route in sel.tracks:routelist():iter() do
	...
	for idx, t in pairs(keyTable) do
		...
		if len2>3 then files:push_back(t.path2) end
              	...
              	-- Editor:do_import (files, Editing.ImportMergeFiles, Editing.ImportToTrack, ARDOUR.SrcQuality.SrcBest, ARDOUR.MidiTrackNameSource.SMFTrackName, ARDOUR.MidiTempoMapDisposition.SMFTempoIgnore, t.pos, ARDOUR.PluginInfo())
